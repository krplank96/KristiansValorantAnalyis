...
### Analysis
First a special thanks to Joshua Broas on Kaggle who pulled all of the data used in this analysis from Vlr.gg. The data being used includes approx. 11.5k matches as of January 2022. 
...
```{r win_loss_plots, echo=FALSE, warning = FALSE, message = FALSE, fig.width= 10, fig.height= 5}
...
```{r regression _plots, echo=FALSE, results = 'asis', warning = FALSE, message = FALSE}
...
```{r function_plots, echo=FALSE, warning = FALSE, fig.width= 12, fig.height= 6}
...
```{r predicted_vs_actual, warning = FALSE, echo = FALSE, message = FALSE, fig.width= 10, fig.height= 5}
...
```{r momentum_table, echo=FALSE, warning = FALSE, fig.width= 10, fig.height= 5}
...
`r print(citation("tidyverse"), bibtex = TRUE) ` 
<br>
`r toBibtex(citation("magrittr")) ` 
<br>
`r toBibtex(citation("janitor")) ` 
<br>
`r toBibtex(citation("lubridate")) ` 
<br>
`r toBibtex(citation("ggplot2")) ` 
<br>
`r toBibtex(citation("scales")) ` 
<br>
`r toBibtex(citation("stargazer")) ` 
<br>
`r toBibtex(citation("ggrepel")) ` 
<br>
`r toBibtex(citation("ggalt")) ` 
<br>
`r toBibtex(citation("zoo")) ` 
<br>
`r toBibtex(citation("RSQLite")) ` 
<br>
`r toBibtex(citation("ggdark")) ` 
<br>
`r toBibtex(citation("showtext")) ` 
<br>
`r toBibtex(citation("reactable")) ` 
<br>
`r toBibtex(citation("kableExtra")) ` 
<br>
`r toBibtex(citation("patchwork")) ` 
