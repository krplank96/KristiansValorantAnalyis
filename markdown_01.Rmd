...
### Analysis
First, a special thanks to Joshua Broas on Kaggle who pulled all of the data used in this analysis from Vlr.gg. The data I used in this analysis includes approximately 11.5k pro and semi-pro Valorant matches as of January 2022. For starters, we have to identify what would define the 9-3 Curse, it is that we would expect that a team down 3-9 is more likely to win the game than its counterpart that is up 9–3 at the attacker/defender switch halfway through the maximum round count. The chart below shows the percentage of matches won at each round differential at half.
<br>
<br>
